...
//    case apiKey = "api_key=705f7bed4894d3adc718c699a8ca9a4f"
    ...
    static func createPopularMoviesURL(for page: Int) -> URL? {
        guard var components = URLComponents(string: MovieServiceParams.baseURL.rawValue + MovieServiceParams.popular.rawValue) else { return nil }
        components.query = "api_key=705f7bed4894d3adc718c699a8ca9a4f"
